...
def steg_model(input_shape, pretrain=False):
    ...
    rconcat_f1 = concatenate(
        [rconv_5x5, rconv_4x4, rconv_3x3], axis=2, name="revl_concat_2")

    secret_pred = Conv1D(input_shape[-1], kernel_size=1, padding="same",
