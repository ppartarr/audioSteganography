...
def steg_model(input_shape, pretrain=False):
    ...
    pconv_3x3 = Conv2D(32, kernel_size=3, padding="same",
                       activation='relu', name='prep_conv3x3_3')(pconv_3x3)
    pconv_3x3 = Conv2D(32, kernel_size=3, padding="same",
                       activation='relu', name='prep_conv3x3_4')(pconv_3x3)

    pconv_4x4 = Conv2D(128, kernel_size=4, padding="same",
    ...
    pconv_4x4 = Conv2D(32, kernel_size=4, padding="same",
                       activation='relu', name='prep_conv4x4_3')(pconv_4x4)
    pconv_4x4 = Conv2D(64, kernel_size=4, padding="same",
                       activation='relu', name='prep_conv4x4_4')(pconv_4x4)

    pconv_5x5 = Conv2D(128, kernel_size=5, padding="same",
    ...
    pconv_5x5 = Conv2D(32, kernel_size=5, padding="same",
    ...
    hconv_3x3 = Conv2D(32, kernel_size=3, padding="same",
                       activation='relu', name='hide_conv3x3_3')(hconv_3x3)
    hconv_3x3 = Conv2D(32, kernel_size=3, padding="same",
                       activation='relu', name='hide_conv3x3_4')(hconv_3x3)

    hconv_4x4 = Conv2D(128, kernel_size=4, padding="same",
    ...
    hconv_4x4 = Conv2D(32, kernel_size=4, padding="same",
                       activation='relu', name='hide_conv4x4_3')(hconv_4x4)
    hconv_4x4 = Conv2D(32, kernel_size=4, padding="same",
                       activation='relu', name='hide_conv4x4_4')(hconv_4x4)

    hconv_5x5 = Conv2D(128, kernel_size=5, padding="same",
    ...
    hconv_5x5 = Conv2D(32, kernel_size=5, padding="same",
    ...
    rconv_3x3 = Conv2D(32, kernel_size=3, padding="same",
    ...
    rconv_4x4 = Conv2D(32, kernel_size=4, padding="same",
    ...
    rconv_4x4 = Conv2D(128, kernel_size=4, padding="same",
                       activation='relu', name='revl_conv4x4_4')(rconv_4x4)

    rconv_5x5 = Conv2D(32, kernel_size=5, padding="same",
    ...
    rconv_5x5 = Conv2D(128, kernel_size=5, padding="same",
